...
struct search_within_vector
{
  ...
  Book * operator()( const auto & )
  {
    ///////////////////////// TO-DO (17) //////////////////////////////
      ...
      for(std::size_t b = 0; b < my_vector.size(); ++b)
      {
        if(my_vector.at(b).isbn() == target_isbn){
          return &my_vector.at(b);
        }
      }
      return nullptr;
    /////////////////////// END-TO-DO (17) ////////////////////////////
...
struct search_within_dll
{
  ...
  Book * operator()( const auto & )
  {
    ///////////////////////// TO-DO (18) //////////////////////////////
      ...
      for(auto sdll = my_dll.begin(); sdll != my_dll.end(); ++sdll)
      {
        if(sdll->isbn() == target_isbn){
          return &*sdll;
        }
      }
      return nullptr;
...
struct search_within_sll
{
  ...
  Book * operator()( const auto & )
  {
    ///////////////////////// TO-DO (19) //////////////////////////////
      ...
      /// that book immediately upon finding it, or a null pointer when you know the book is not in the container.
      for(auto ssll = my_sll.begin(); ssll != my_sll.end(); ++ssll){
        if(ssll->isbn() == target_isbn){
          return &*ssll;
        }
      }
      return nullptr;
